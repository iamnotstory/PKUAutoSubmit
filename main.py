...
if __name__ == '__main__':
    ...
    parser.add_argument('--reason', type=str, help='出校原因, eg. 吃饭', default='跟同学吃饭')
    parser.add_argument('--destination', type=str, help='出校目的地, eg. 北京', default='中关村')
    parser.add_argument('--track', type=str, help='出校轨迹, eg. 畅春园食堂', default='北大南门-中关村')
